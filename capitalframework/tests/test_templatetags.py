...
from capitalframework.templatetags.capitalframework import SVG_REGEX, cf_icon
...
class IconTests(TestCase):
    def test_assert_renders_valid_svg_from_staticfiles_icons(self):
        self.assertEqual(cf_icon('test'), VALID_SVG)

    def test_svg_icon_result_marked_safe_for_rendering(self):
        self.assertIsInstance(cf_icon('test'), SafeData)
